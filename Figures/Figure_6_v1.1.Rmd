...
subtitle: "Figure 6: MRT67307 and BX795 enhance plasmid trasfection in VSMC"
author: "Shuai Yuan"
...
vtSample <- c(0, 0, 20*0.5^c(9:0)) %>%
  ...
  str_replace("\\.$", "")
vtSample <- paste("BX795", vtSample, "uM")
...
dfBlot <- data.frame(
  ...
  mutate(
    target = factor(target, levels = target), 
    imgPath = c(
      glue("{root_dir}/20230602_HASMC_pCIGX-R4_OE0.4ug_12well_BX795_0-20uM/20230602_CYB5R4_GFP.tif"), 
      glue("{root_dir}/20230602_HASMC_pCIGX-R4_OE0.4ug_12well_BX795_0-20uM/20230602_CYB5R4_GFP.tif"), 
      glue("{root_dir}/20230602_HASMC_pCIGX-R4_OE0.4ug_12well_BX795_0-20uM/20230602_aTub.tif")),
    x = c(0.1, 0.1, 0.125), 
    y = c(0.305, 0.61, 0.75), 
...
dfBlot <- data.frame(
  ...
  mutate(
    target = factor(target, levels = target), 
    imgPath = c(
      glue("{root_dir}/20230529_RASMC_pCIGX-R4_OE0.4ug_12well_BX795_0-20uM/20230529_CYB5R4_GFP.tif"), 
      glue("{root_dir}/20230529_RASMC_pCIGX-R4_OE0.4ug_12well_BX795_0-20uM/20230529_CYB5R4_GFP.tif"), 
      glue("{root_dir}/20230529_RASMC_pCIGX-R4_OE0.4ug_12well_BX795_0-20uM/20230529_aTub.tif")),
    x = c(0.1, 0.1, 0.1), 
    y = c(0.33, 0.67, 0.75), 
