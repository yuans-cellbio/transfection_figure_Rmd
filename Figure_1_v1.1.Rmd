...
dfBlot <- data.frame(
  ...
  mutate(
    ...
    imgPath = c(
      glue("{root_dir}/20230215_HAEC_pCIGX-R4_OE0.4ug_12well_MRT67307_BX765_20uM_0.5dilutions/20230215_MRT67307_CYB5R4.tif"),
      glue("{root_dir}/20230215_HAEC_pCIGX-R4_OE0.4ug_12well_MRT67307_BX765_20uM_0.5dilutions/20230215_MRT67307_GFP.tif"),
      glue("{root_dir}/20230215_HAEC_pCIGX-R4_OE0.4ug_12well_MRT67307_BX765_20uM_0.5dilutions/20230215_MRT67307_aTub.tif")),
    x = c(0.07, 0.065, 0.08), 
    y = c(0.38, 0.7, 0.38), 
...
dfBlot <- data.frame(
  ...
  mutate(
    target = factor(target, levels = target), 
    imgPath = c(
      glue("{root_dir}/20230215_HAEC_pCIGX-R4_OE0.4ug_12well_MRT67307_BX765_20uM_0.5dilutions/20230215_BX765_CYB5R4.tif"), 
      glue("{root_dir}/20230215_HAEC_pCIGX-R4_OE0.4ug_12well_MRT67307_BX765_20uM_0.5dilutions/20230215_BX765_GFP.tif"),
      glue("{root_dir}/20230215_HAEC_pCIGX-R4_OE0.4ug_12well_MRT67307_BX765_20uM_0.5dilutions/20230215_BX765_aTub.tif")),
